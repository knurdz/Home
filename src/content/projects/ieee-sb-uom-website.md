...
Student branches run on volunteer energy, but outdated or fragmented web presence makes it hard to showcase impact, recruit members, and centralize contact. The IEEE SB at Moratuwa needed a single, credible destination that reflects the scale of their community and makes it easy for students and partners to get involved.
...
The homepage leads with the branch story and impact metrics, then guides visitors toward community participation and direct contact. The design supports both discovery (what IEEE SB UoM does) and action (join, collaborate, or reach out).

## Stack

| Layer | Technology |
|---|---|
| Frontend | Modern web stack (SPA) |
| Deployment | Production hosting |
| Content | Events, chapters, and community sections |

## Status

Live at [ieeesb.uom.lk](https://ieeesb.uom.lk). The site serves as the primary public channel for the IEEE Student Branch, University of Moratuwa.
