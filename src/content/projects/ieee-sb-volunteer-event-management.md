...
IEEE Student Branches run dozens of events per year with rotating volunteer teams. Organizers lose time reconciling sign-up forms, tracking who showed up, assigning roles, sending updates, and keeping sponsor and delegate materials in sync. Generic tools weren't designed for how student branches actually operate.
...
| Frontend | TBD |
| Backend | TBD |
| Infrastructure | Knurdz-managed cloud stack |
